    ...
    return Padding(
        ...
        child: Column(
            ...
            children: [
              ...
              Text("lbl_share_my_ride".tr,
                  style: CustomTextStyles.titleMediumBold),
              Padding(
                  padding: getPadding(top: 15),
                  child: Text("msg_share_my_ride_information".tr,
                        ...
                        children: [
                          Row(
                              ...
                              children: [
                                ...
                                Padding(
                                    padding:
                                        getPadding(left: 22, top: 4, bottom: 3),
                                    child: Column(
                                        crossAxisAlignment:
                                        ...
                                        children: [
                                          Text("msg_mr_esther_howards".tr,
                                              style: CustomTextStyles
                                                  .titleMediumBold),
                                          Padding(
                                              padding: getPadding(top: 9),
                                              child: Text(
                                                  "msg_relation_father".tr,
                                                  style: CustomTextStyles
                                                      .bodyMediumGray500))
                                        ]))
                              ]),
                          (controller.selectedIndex.value == 0)
                              ? CustomImageView(
                                  ...
                                  width: getSize(24),
                                  margin:
                                      getMargin(top: 14, right: 8, bottom: 14))
                              : CustomImageView(
                                  svgPath: ImageConstant.imgCheckmarkBlack900,
                                  height: getSize(24),
                                  width: getSize(24),
                                  margin:
                                      getMargin(top: 14, right: 5, bottom: 14))
                        ]))),
              ),
              GestureDetector(
                onTap: () {
                        ...
                        children: [
                          Row(
                              ...
                              children: [
                                ...
                                Padding(
                                    padding:
                                        getPadding(left: 19, top: 6, bottom: 3),
                                    child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        mainAxisAlignment:
                                            MainAxisAlignment.start,
                                        children: [
                                          Text("msg_mrs_jenny_wilson".tr,
                                              style: CustomTextStyles
                                                  .titleMediumBold),
                                          Padding(
                                              padding: getPadding(top: 7),
                                              child: Text(
                                                  "msg_relation_mother".tr,
                                                  style: CustomTextStyles
                                                      .bodyMediumGray500))
                                        ]))
                              ]),
              ...
              CustomElevatedButton(
                  text: "lbl_share_ride".tr,
                  margin: getMargin(top: 24, bottom: 32),
                  onTap: () {
                    onTapShareride();
                  })
            ]));
